  ...
  switch (templateId) {
    ...
    case 'modern':
      return {
        ...
        professionalSummary: `Results-driven Accounting and Finance professional with over 6 years of experience in financial reporting, budgeting, tax compliance, and strategic financial analysis. Skilled in streamlining accounting processes, ensuring regulatory compliance, and providing actionable insights to support business decisions.`,
        ...
        skills: [
          ...
          'IFRS', 'Financial Analysis', 'Accounts Reconciliation', 'Payroll Management',
          'QuickBooks', 'Peachtree', 'SAP', 'Advanced Excel', 'Power BI', 'Auditing'
        ],
        ...
        projects: [
          ...
          {
            id: 2,
            name: 'Budget Optimization Project',
            description: 'Developed comprehensive budget model reducing operational costs by 15%.',
            techStack: 'Financial Modeling, Advanced Excel',
            demoLink: '',
            githubLink: ''
          }
        ],
