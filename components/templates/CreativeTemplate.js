          ...
          <div className="space-y-8">
            ...
            <section className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
              ...
              <div className="grid grid-cols-2 gap-3">
                <span className="text-center bg-gray-50 text-gray-700 py-2 rounded-lg">UI/UX Design</span>
                <span className="text-center bg-pink-50 text-pink-700 py-2 rounded-lg">Photography</span>
                <span className="text-center bg-gray-50 text-gray-700 py-2 rounded-lg">Travel</span>
