...
export default function MinimalTemplate({ resume }) { 
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto p-3">
        ...
        {professionalSummary && (
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 uppercase tracking-wide">Summary</h2>
   ...
   {/* Certifications */}
            {certifications.length > 0 && (
              <section>
                <h2 className="text-xl font-semibold text-gray-900 mb-6 uppercase tracking-wide">Certifications</h2>
                <div className="space-y-3 text-sm">
                  {certifications.map((cert) => (
                    <div key={cert.id} className="text-gray-700">
                      <div className="font-medium">{cert.name}</div>
                      <div className="text-green-600">{cert.organization}</div>
                ...
                <div className="space-y-2 text-sm">
                  {languages.map((lang) => (
                    <div key={lang.id} className="flex justify-between text-gray-700">
                      ...
                      <span className="text-green-600">{lang.proficiency}</span>
                    </div>
                  ))}
                </div>
              </section>
  ...
  {/* Education */}
            ...
            {achievements.length > 0 && (
              <section>
                <h2 className="text-xl font-semibold text-gray-900 mb-6 uppercase tracking-wide">Achievements</h2>
                <div className="space-y-3 text-sm">
                  {achievements.map((achievement) => (
                    <div key={achievement.id} className="text-gray-700">
                      <div className="font-medium">{achievement.title}</div>
                      <div className="text-green-600">{achievement.organization}</div>
                      <div className="text-gray-500">{achievement.year}</div>
            ...
            {interests.length > 0 && (
              <section>
                <h2 className="text-xl font-semibold text-gray-900 mb-6 uppercase tracking-wide">Interests</h2>
